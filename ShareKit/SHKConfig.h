...
#define SHKMyAppName			@"Social Tunes"
#define SHKMyAppURL				@"http://bitformed.com/socialtunes"
...
#define SHKDeliciousConsumerKey		@"dj0yJmk9NnJnNFdvUWNoTWFqJmQ9WVdrOVJFbDFhbmxhTkc4bWNHbzlOVFUzTVRZMU56WXkmcz1jb25zdW1lcnNlY3JldCZ4PTY0"
#define SHKDeliciousSecretKey		@"2c5944e4cc78eb3caaa6e846163b49bea288934a"
...
#define SHKFacebookKey				@"de3970edf92fc8237892167fe1277787"
#define SHKFacebookSecret			@"" //4fc9c0da1d2c6cd2365cb3dd45ce3364	
#define SHKFacebookSessionProxyURL  @""

// Read It Later - http://readitlaterlist.com/api/?shk
#define SHKReadItLaterKey			@"cp0AQmU6d8fR4Rs58epxM3cX7eTxh53d"
 ...
 */
#define SHKTwitterConsumerKey		@"G9oD8cCmwepcqp2pYvF2g"
#define SHKTwitterSecret			@"DtygK4etM1UCLSK0fDrrzuyQw8GcIJiSlzE0i5ZQQ"
#define SHKTwitterCallbackUrl		@"http://www.bitformed.com/secret/twt_oauth_callback" // You need to set this if using OAuth, see note above (xAuth users can skip it)
#define SHKTwitterUseXAuth			0 // To use xAuth, set to 1
#define SHKTwitterUsername			@"socialtunesapp" // Enter your app's twitter account if you'd like to ask the user to follow it when logging in. (Only for xAuth)

// Bit.ly (for shortening URLs on Twitter) - http://bit.ly/account/register - after signup: http://bit.ly/a/your_api_key
#define SHKBitLyLogin				@"bitformed"
#define SHKBitLyKey					@"R_96846b915db825404dd1112b84643cbb"
